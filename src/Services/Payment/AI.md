...
The shared event-bus host service exports Payment outbox backlog count, oldest-message age, and polling failures through the Payment OpenTelemetry meter.
