    ...
    : ICommandHandler<GetOrCreateExternalUserCommand, Result<UserResponse>>
{
    ...
    public GetOrCreateExternalUserCommandHandler(
    ...
    {
        ExternalUserProfile profile = command.Profile;
        ...
        Guid? existingUserId = await userIdentityReader.FindIdByEmailAsync(email, cancellationToken);
