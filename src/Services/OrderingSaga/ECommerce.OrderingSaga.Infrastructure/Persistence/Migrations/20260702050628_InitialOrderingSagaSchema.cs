...
{
    public partial class InitialOrderingSagaSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_workflows", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_workflow_items", x => x.id);
                    table.ForeignKey(
                        name: "FK_order_workflow_items_order_workflows_workflow_id",
                        column: x => x.workflow_id,
                        principalTable: "order_workflows",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_workflow_items_workflow_id",
                table: "order_workflow_items",
                column: "workflow_id");

            migrationBuilder.CreateIndex(
                name: "IX_order_workflows_order_id",
                table: "order_workflows",
                column: "order_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_order_workflows_status",
                table: "order_workflows",
                column: "status");
